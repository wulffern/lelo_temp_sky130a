...
C {JNW_ATR_SKY130A/JNWATR_NCH_4C5F0.sym} 420 -510 0 0 {name=xg3 }
...
C {devices/ipin.sym} 40 -510 0 0 {name=p3 lab=PWRUP_1V8}
...
C {devices/ipin.sym} 30 -790 0 0 {name=p1 lab=PWRUP_N_1V8}
