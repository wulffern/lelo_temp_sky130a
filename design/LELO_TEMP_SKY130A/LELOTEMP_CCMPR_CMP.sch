...
C {devices/iopin.sym} 0 100 0 0 {name=p5 lab=RST}
...
C {LELO_TEMP_SKY130A/LELOTEMP_CMPR.sym} 400 0 0 0 {name=Xx1_cmp}
...
N 280.0 -60.0 300.0 -60.0 {lab=RST}
C {devices/lab_pin.sym} 280.0 -60.0 0 0 {name=l8 sig_type=std_logic lab=RST }
